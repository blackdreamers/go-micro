...
// source: github.com/blackdreamers/go-micro/examples/v3/helloworld/proto/greeter.proto
...
func init() {
	proto.RegisterFile("github.com/blackdreamers/go-micro/examples/v3/helloworld/proto/greeter.proto", fileDescriptor_f59dc6c921369088)
}
